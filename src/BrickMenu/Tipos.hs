...
data Name = MenuPrincipal 
          ...
          | ListaAlunos | ListaProfessores | ListaTurmas | ListaDisciplinas | ListaSolicitacoes | ListaConflitos
          | ScrollRelatorio
          deriving (Ord, Show, Eq)

data Tela = TelaInicial 
          | TelaMenu 
          | TelaCadAluno | TelaCadProfessor | TelaCadDisciplina | TelaCadTurma 
          | TelaListaAlunos | TelaListaProfessores | TelaListaTurmas | TelaListaDisciplinas
          | TelaConflitos 
          | TelaEditarTurma 
          | TelaCadSolicitacao | TelaListaSolicitacoes
          | TelaLancarNotas
          | TelaRelatorio 
          | TelaConfirmacao | TelaConfirmacaoFimSemestre
    deriving (Eq, Show)
...
data AppState = AppState
  ...
  , _listaMenuSolicitacoes :: L.List Name (Matricula, Codigo)
  , _listaConflitos :: L.List Name (Turma, Turma)
  , _turmaEmEdicao :: Maybe Codigo
